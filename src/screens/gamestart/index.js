...
import {components} from '../../utils/constantes/components';
import {theme} from '../../utils/constantes/theme';


export const GameStartScreen = ({onStartGame}) => {
  ...
  const confirmedOuput = confirmed ? (
    <View style={styles.confirmedContainer}>
      ...
      <Button title="Empezar juego" onPress={() => handleStartGame()} color="#904E55"/>
    </View>
) : null;
